...
<div id="header">
			<div class="left">
				<a href="home.php"><h1 style="font-size: 18px; font-style: #bbb; color: red;">WELCOME </h1><H2><p>KELDAN INVENTORY</p></H2></a>
			...
			<div class="center" style="font-size: 30px;">
				<?php
				if($headrole == 1 || $headrole == 2 || $headrole == 3)
					echo '<a href="categories.php" title="categories"><b>CATEGORIES</b></a>';
				?>
			</div>
			<div class="clear"></div>
		</div>
